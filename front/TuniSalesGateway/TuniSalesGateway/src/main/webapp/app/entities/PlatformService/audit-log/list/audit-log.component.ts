...
import { EntityArrayResponseType, AuditLogService } from '../service/audit-log.service';
...
export class AuditLogComponent implements OnInit {
  ...
  trackId = (_index: number, item: IAuditLog): number => this.auditLogService.getAuditLogIdentifier(item);
