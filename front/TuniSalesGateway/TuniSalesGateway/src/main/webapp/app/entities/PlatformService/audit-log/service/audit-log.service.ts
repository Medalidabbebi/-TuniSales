...
type RestOf<T extends IAuditLog | NewAuditLog> = Omit<T, 'createdAt'> & {
...
export class AuditLogService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/audit-logs', 'platformservice');
