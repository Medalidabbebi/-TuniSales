...
describe('ClientContact Management Component', () => {
  let comp: ClientContactComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'client-contact', component: ClientContactComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ClientContactComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to clientContactService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getClientContactIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getClientContactIdentifier).toHaveBeenCalledWith(entity);
