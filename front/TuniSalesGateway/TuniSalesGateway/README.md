...
The dashboard UI is being refreshed one screen at a time, using the Client list as the visual reference.
...
2. Invoice list
3. Delivery screens
4. Mission and Visit screens
5. Inventory screens
6. Performance screens
7. Admin screens

Design direction:

- Use the same card-based page header, summary blocks, and table treatment across screens.
- Keep Client as the reference style and bring other entities up to the same visual quality.
- Prefer lighter layouts with stronger spacing, clearer badges, and consistent action buttons.
...
To build the final jar and optimize the TuniSalesGateway application for production, run:
