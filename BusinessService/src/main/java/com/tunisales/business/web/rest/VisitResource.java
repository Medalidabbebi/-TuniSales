...
import com.tunisales.business.service.VisitQueryService;
...
/**
 * REST controller for managing {@link com.tunisales.business.domain.Visit}.
 * write → ROLE_COMMERCIAL; read/write → ROLE_ADMIN_COMMERCIAL.
 */
@RestController
@RequestMapping("/api")
@PreAuthorize(
...
public class VisitResource {
    ...
    private static final String ENTITY_NAME = "businessServiceVisit";
