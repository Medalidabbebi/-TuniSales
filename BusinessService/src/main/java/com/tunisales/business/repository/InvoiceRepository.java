...
public interface InvoiceRepository extends JpaRepository<Invoice, Long>, JpaSpecificationExecutor<Invoice> {
    ...
    @Query(
        value = "select distinct invoice from Invoice invoice left join fetch invoice.client left join fetch invoice.order",
    ...
    @Query("select distinct invoice from Invoice invoice left join fetch invoice.client left join fetch invoice.order")
