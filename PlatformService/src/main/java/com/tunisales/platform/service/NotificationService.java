...
public class NotificationService {
    ...
    /**
     * Get notifications for a specific recipient login.
     */
    @Transactional(readOnly = true)
    public Page<NotificationDTO> findByRecipientLogin(String recipientLogin, Pageable pageable) {
        log.debug("Request to get Notifications for recipient: {}", recipientLogin);
        return notificationRepository.findByRecipientLogin(recipientLogin, pageable).map(notificationMapper::toDto);
    }
