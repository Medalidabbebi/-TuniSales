...
import com.tunisales.platform.service.AuditLogQueryService;
import com.tunisales.platform.service.AuditLogService;
...
/**
 * REST controller for managing {@link com.tunisales.platform.domain.AuditLog}.
 * Restricted to ROLE_ADMIN_SYSTEME and ROLE_ADMIN_COMMERCIAL.
 */
@RestController
@RequestMapping("/api")
@PreAuthorize(
...
public class AuditLogResource {
    ...
    private static final String ENTITY_NAME = "platformServiceAuditLog";
