...
import { EntityArrayResponseType, SwapService } from '../service/swap.service';
...
export class SwapComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.swaps = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ISwap[] | null): ISwap[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.swapService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
