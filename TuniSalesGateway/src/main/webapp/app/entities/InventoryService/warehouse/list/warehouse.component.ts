...
import { EntityArrayResponseType, WarehouseService } from '../service/warehouse.service';
...
export class WarehouseComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.warehouses = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IWarehouse[] | null): IWarehouse[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.warehouseService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
