...
describe('Objective Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'objective', component: ObjectiveComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ObjectiveComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to objectiveService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getObjectiveIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getObjectiveIdentifier).toHaveBeenCalledWith(entity);
