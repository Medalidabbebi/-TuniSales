...
type RestOf<T extends ITenant | NewTenant> = Omit<T, 'createdAt' | 'updatedAt'> & {
...
export class TenantService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/tenants', 'platformservice');
