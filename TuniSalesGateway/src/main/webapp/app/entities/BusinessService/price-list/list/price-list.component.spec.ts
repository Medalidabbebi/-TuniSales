...
describe('PriceList Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'price-list', component: PriceListComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.priceLists?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to priceListService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPriceListIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPriceListIdentifier).toHaveBeenCalledWith(entity);
